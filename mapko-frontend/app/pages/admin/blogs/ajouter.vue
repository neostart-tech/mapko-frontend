        ...
        <div class="form-grid">
          ...
          <div class="form-main">
            <div class="form-group">
              ...
              <input type="text" v-model="form.titre" placeholder="Saisissez un titre accrocheur..." required />
            </div>
...
.image-upload-box.cover:not(.has-image):hover {
  background: #f1f5f9;
  border-color: var(--color-violet);
  cursor: pointer;
}
...
.gallery-add-btn:hover { border-color: var(--color-violet); background: #fdf4ff;}
