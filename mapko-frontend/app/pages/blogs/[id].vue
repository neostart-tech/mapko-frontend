    ...
    <section class="blogs-section">
      <div class="blogs-container">
        ...
        <main class="blogs-main">
          ...
          <AdminLoader :visible="loading && !currentBlog" inline />

          <!-- Si non trouvé -->
          <div v-if="!loading && !currentBlog" class="blog-article animate-reveal text-center py-20">
            ...
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Oups ! Article introuvable.</h2>
            <p class="text-gray-500 mb-8">Il semblerait que l'article que vous recherchez n'existe plus ou a été déplacé.</p>
            <NuxtLink to="/blogs" class="btn-reset">Retourner aux blogs</NuxtLink>
          </div>
